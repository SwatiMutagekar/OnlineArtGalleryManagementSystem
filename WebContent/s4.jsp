...
<img border=10  style=" float:left;display:inline"  src="surrealism/4.jpg"  width="900" height="600" hspace="20" vspace="20" alt=""/>
<%
try{
	...
	Connection con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","system","system");
		...
		String sql="select s.artno,s.pname,s.category,s.price,s.year,s.psize,s.painttype,ar.artist_name from artist ar,allpaintings s where ar.artist_id=s.artist_id and s.artno='s4'";
...
<h2 align="left">
 ...
 <button style='margin-left:50px' name="artno" value="s4">ADD TO CART</button></form><br>
