...
<img border=10  style=" float:left;display:inline"  src="portrait/1.jpg"  width="750" height="600" hspace="20" vspace="20" alt=""/>
<%
try{
	...
	Connection con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","system","system");
		...
		String sql="select p.artno,p.pname,p.category,p.price,p.year,p.psize,p.painttype,ar.artist_name from artist ar,allpaintings p where ar.artist_id=p.artist_id and p.artno='p1'";
...
<h2 align="left">
 ...
 <button style='margin-left:50px' name="artno" value="p1">ADD TO CART</button></form><br>
