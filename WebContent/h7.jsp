...
<img border=10  style=" float:left;display:inline"  src="hyperrealism/7.jpg"  width="900" height="600" hspace="20" vspace="20" alt=""/>
<%
try{
	...
	Connection con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","system","system");
		...
		String sql="select h.artno,h.pname,h.category,h.price,h.year,h.psize,h.painttype,ar.artist_name from artist ar,allpaintings h where ar.artist_id=h.artist_id and h.artno='h7'";
...
<h2 align="left">
 ...
 <button style='margin-left:50px' name="artno" value="h7">ADD TO CART</button></form><br>
 <a href="hyperrealism.jsp"><button style='margin-left:50px' >BACK</button></h2></a>
</body>
</html>