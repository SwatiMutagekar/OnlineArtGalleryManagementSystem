...
<img border=10  style=" float:left;display:inline"  src="newimpressionism/10.jpg"  width="500" height="600" hspace="20" vspace="20" alt=""/>
<%
try{
	...
	Connection con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","system","system");
		...
		String sql="select i.artno,i.pname,i.category,i.price,i.year,i.psize,i.painttype,ar.artist_name from artist ar,allpaintings i where ar.artist_id=i.artist_id and i.artno='i10'";
...
<h2 align="left">
 ...
 <button style='margin-left:50px' name="artno" value="i10">ADD TO CART</button></form><br>
