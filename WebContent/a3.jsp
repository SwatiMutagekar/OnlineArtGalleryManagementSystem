...
<img border=10  style=" float:left;display:inline"  src="abstract/3.jpg"  width="900" height="600" hspace="20" vspace="20" alt=""/>
<%
try{
	...
	Connection con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","system","system");
		...
		String sql="select a.artno,a.pname,a.category,a.price,a.year,a.psize,a.painttype,ar.artist_name from artist ar,allpaintings a where ar.artist_id=a.artist_id and a.artno='a3'";
...
<h2 align="left">
 ...
 <button style='margin-left:50px' name="artno" value="a3">ADD TO CART</button></form><br>
