...
<img border=10  style=" float:left;display:inline"  src="conceptual/6.jpg"  width="900" height="600" hspace="20" vspace="20" alt=""/>
<%
try{
	...
	Connection con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","system","system");
		...
		String sql="select c.artno,c.pname,c.category,c.price,c.year,c.psize,c.painttype,ar.artist_name from artist ar,allpaintings c where ar.artist_id=c.artist_id and c.artno='c6'";
...
<h2 align="left">
 ...
 <button style='margin-left:50px' name="artno" value="c6">ADD TO CART</button></form><br>
